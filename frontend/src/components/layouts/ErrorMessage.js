...
export default function ErrorMessage() {
  ...
  return (
    error && (
      <div className="fixed top-6 right-6 z-[100] w-fit max-w-sm animate-zoom-in">
        <div className="bg-surface/90 backdrop-blur-xl rounded-2xl shadow-premium-lg border border-danger/20 p-0.5">
          <div className="flex items-center p-3 pr-4 gap-2.5 bg-danger/5 rounded-[14px]">
            ...
            <div className="flex-1 min-w-0 max-w-[280px]">
              <p className="text-[13px] font-bold text-danger leading-relaxed">
                {error}
              </p>
            </div>
          </div>
